    ...
    <div class="mx-auto w-full max-w-md p-6">
      ...
      >
        <div class="p-4 sm:p-7">
          ...
          <div class="mt-5">
            <x-buttons.google-btn title="Sign in with Google" />
            ...
            <form>
              <div class="grid gap-y-4">
                <x-forms.input.email-input id="login-email" errorId="login-email-error" />
                ...
                />
                <x-forms.input.checkbox id="remember-me" />
                <x-buttons.auth-btn title="Sign in" />
              </div>
            </form>
          </div>
        </div>
